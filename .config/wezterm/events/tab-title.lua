...
M.set_title = function(tab_index, process_name, static_title, active_title, max_width, inset)
    local title
    inset = inset or 6
...
M.setup = function()
    wezterm.on("format-tab-title", function(tab, tabs, panes, config, hover, max_width)
        ...
        local title = M.set_title(tab.tab_index, process_name, tab.tab_title, tab.active_pane.title, max_width,
            (is_admin and 8))
